...
```
  ...
  1. $input$: a list of the initial values and parameters used in the simulation.
  ...
  3. $outmat$: a matrix of simulation results where rows are time steps and columns are model components or parameters. 
